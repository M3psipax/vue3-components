...
import R from './../../../modules/qr-scanner/vue3-components.js';
import $ from "../../i18n/vue3-components2.js";
import { loadI18n as q } from "../../i18n/vue3-components.js";
import b from './../../../modules/@nimiq/utils/dist/module/vue3-components.js';
...
const H = E({
  ...
  setup(n, l) {
    const r = o(null), s = o(null), i = o(null), u = o(!1), p = o(!0), M = b.isMobile(), L = b.detectBrowser();
    let t = null, y = "", w = 0, a = null;
    O(async () => {
      t = new R(s.value, (e) => D(e), {}), s.value.addEventListener("canplay", () => s.value.classList.add("ready")), window.addEventListener("resize", c), R.hasCamera().then((e) => p.value = e), F() && (v(), c());
    }), T(() => {
